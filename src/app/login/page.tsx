    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-background">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-6">
          <AppLogo size={48} />
          <h1 className="text-xl font-semibold text-foreground mt-3">SI WorkLog</h1>
        ...
        <div className="bg-card border border-border rounded-xl shadow-xl p-6 fade-in">
          ...
          >
            {busy ? (
              ...
              <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true">
                <path fill="#FFC107" d="M43.6 20.1H42V20H24v8h11.3C33.7 32.7 29.2 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.2 8 3l5.7-5.7C34.2 6 29.4 4 24 4 13 4 4 13 4 24s9 20 20 20 20-9 20-20c0-1.3-.1-2.6-.4-3.9z" />
                <path fill="#FF3D00" d="M6.3 14.7l6.6 4.8C14.7 15.1 19 12 24 12c3.1 0 5.9 1.2 8 3l5.7-5.7C34.2 6 29.4 4 24 4 16.3 4 9.7 8.3 6.3 14.7z" />
          ...
          {accessError && (
            <p className="mt-3 text-xs text-red-500 leading-relaxed">{accessError}</p>
          )}

          <p className="mt-4 text-xs text-muted-foreground leading-relaxed">
            Note: only emails added by an admin can sign in. Google and Email/Password must be enabled
            in Firebase Authentication, with <span className="font-mono">localhost:4028</span> authorized.
          </p>
        </div>
